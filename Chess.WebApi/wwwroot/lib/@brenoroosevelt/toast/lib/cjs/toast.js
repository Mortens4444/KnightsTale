...
exports.system = exports.success = exports.error = exports.warning = exports.info = exports.create = exports.ToastTypes = void 0;
const _default = {
    type: 'default',
    title: undefined,
    position: 'top',
...
const style = {
    ...
    init() {
        ...
        // @ts-ignore
        this.initialized = (_a = document.head) === null || _a === void 0 ? void 0 : _a.appendChild(css);
    }
};
...
const create = (message, options = {}) => {
    return new Promise((resolve, reject) => {
        ...
        if (_options.duration)
            setTimeout(() => dismiss({ text: "timeout", value: "timeout" }), _options.duration);
        if (!_options.shadow)
        ...
        _options.actions.forEach((action, i) => {
            ...
            if (action.bgColor)
                d.style.backgroundColor = action.bgColor;
...
const info = (message, options = {}) => create(message, merge(options, { type: 'info' }));
exports.info = info;
const warning = (message, options = {}) => create(message, merge(options, { type: 'warning' }));
exports.warning = warning;
const error = (message, options = {}) => create(message, merge(options, { type: 'error' }));
exports.error = error;
const success = (message, options = {}) => create(message, merge(options, { type: 'success' }));
exports.success = success;
const system = (message, options = {}) => create(message, merge(options, { type: 'system' }));
