...
public class ArtificalIntelligenceMovesTest
{
    ...
    [TestCase("Chess.Test.Resources.ChessTableState - BestMoveForBlack.cgs", typeof(Lvl4_NoMoreMoronMoves), "B3 - A3")]
    ...
    public void MoveChooseTest(string chessTableResourceName, Type artificalIntelligenceType, params string[] expectedChoosenMoves)
    {
        ...
        var move = GetAIMove(chessTable, artificalIntelligenceType, expectedChoosenMoves);
    ...
    public void MoveChooseTestWithCheck(string chessTableResourceName, Type artificalIntelligenceType, params string[] expectedChoosenMoves)
    {
        var chessTable = ResourceLoader.GetChessTable(chessTableResourceName);
        GetAIMove(chessTable, artificalIntelligenceType, expectedChoosenMoves);
    }

    private static Move GetAIMove(ChessTable chessTable, Type artificalIntelligenceType, string[] expectedChoosenMoves)
    {
